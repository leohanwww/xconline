...
public class RabbitMQConfig {
     ...
     */
    @Bean
    public Binding binding_queue_media_processtask_finish(@Qualifier(XC_LEARNING_FINISHADDCHOOSECOURSE) Queue queue,
    ...
    //添加选课绑定
    @Bean
    public Binding binding_queue_media_processtask_add(@Qualifier(XC_LEARNING_ADDCHOOSECOURSE) Queue queue,
                                                   @Qualifier(EX_LEARNING_ADDCHOOSECOURSE) Exchange exchange) {
